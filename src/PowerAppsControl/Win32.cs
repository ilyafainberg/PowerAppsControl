...
// -----------------------------------------------------------------------------
//  PowerAppsControl — Win32 P/Invoke surface
//
...
/// <summary>
/// All P/Invoke declarations PowerAppsControl needs from the Windows API:
///
...
internal static class Win32
{
    ...
    /// <summary>Handle of the window the user is currently working in (foreground).</summary>
    [DllImport("user32.dll")]
    ...
    /// <summary>True when the window is maximized (zoomed).</summary>
    [DllImport("user32.dll")]
    public static extern bool IsZoomed(IntPtr hWnd);

    /// <summary>Monitor handle that most-intersects a window (for work-area / bounds queries).</summary>
    [DllImport("user32.dll")]
    ...
    {
        public int cbSize;
        public RECT rcMonitor;   // full monitor bounds (physical pixels)
